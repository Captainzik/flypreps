  ...
  return (
    <main className='space-y-6'>
      <section className='rounded-xl border dark:border-slate-700 dark:bg-slate-800 p-6 shadow-sm'>
        <h1 className='text-2xl font-bold dark:text-white'>Start a Quiz</h1>
      ...
      {quizzes.length === 0 ? (
        <section className='rounded-xl border border-dashed dark:border-slate-600 dark:bg-slate-800 p-8 text-center'>
          ...
          <Link
            href='/quiz'
            className='mt-4 inline-flex rounded-md border dark:border-slate-600 px-4 py-2 text-sm font-medium dark:text-slate-400 hover:bg-slate-700'
          >
          ...
          {quizzes.map((quiz) => {
            ...
            return (
              ...
              >
                ...
                <p className='line-clamp-3 text-sm dark:text-slate-400'>
                  {quiz.description}
                </p>

                <p className='mt-3 text-xs dark:text-slate-400'>
                  {quiz.questionsCount} question
                  {quiz.questionsCount === 1 ? '' : 's'}
                </p>

                {!hasQuestions ? (
                  <p className='mt-2 rounded-md dark:bg-amber-950 px-2 py-1 text-xs dark:text-amber-300'>

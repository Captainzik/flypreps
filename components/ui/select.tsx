  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'flex items-center justify-between gap-2 rounded-md border px-3 py-2 text-sm shadow-sm outline-none',
        className,
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'bg-white text-slate-900 shadow-md dark:bg-slate-900 dark:text-slate-50',
          'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95',
          'relative z-50 min-w-32 overflow-hidden rounded-md border border-slate-200 dark:border-slate-700',
          position === 'popper' &&
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        'bg-slate-200 pointer-events-none -mx-1 my-1 h-px dark:bg-slate-700',
        className,
      )}
      {...props}
    />
